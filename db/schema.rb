...
ActiveRecord::Schema.define(version: 20160413112406) do
  ...
  add_index "line_items", ["status_id"], name: "index_line_items_on_status_id", using: :btree
  ...
  add_foreign_key "line_items", "statuses"
